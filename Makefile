...
COFFEE_FILES := $(COFFEE_DIR)/Model.coffee $(COFFEE_DIR)/Searcher.coffee $(COFFEE_DIR)/Configuration.coffee $(COFFEE_DIR)/Parser.coffee $(COFFEE_DIR)/ModuleView.coffee $(COFFEE_DIR)/ESChecker.coffee ${COFFEE_DIR}/ModuleList.coffee
